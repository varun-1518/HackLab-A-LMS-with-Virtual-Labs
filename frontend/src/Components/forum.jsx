...
function Forum() {
  ...
  return (
    <div className="Forum">
      <h2 style={{ color: 'black', marginLeft: '16px', marginBottom: '20px' }}>Discussion Forum for {course?.course_name}</h2>
            ...
            if (value.content.trim() !== "") {
              return (
                <div className='taskItem' key={key}>
                  <p style={{ color: 'black' }}>
                    <div style={{fontSize:"12px", padding:"2px", borderRadius:"8px", color:"brown", marginLeft:"-9px", marginTop:"-10px", fontWeight:"bold"}}>
                      {value.uName}
                    </div>
                    {value.content}
                  </p>
